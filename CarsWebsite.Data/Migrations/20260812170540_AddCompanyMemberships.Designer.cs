...
namespace cars_website_api.CarsWebsite.Data.Migrations
{
    ...
    [Migration("20260812170540_AddCompanyMemberships")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarsWebsite.CompanyMembership", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarsWebsite.PartnerFieldMapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PartnerId", "OurField")
                        .IsUnique();

                    b.ToTable("partnerfieldmappings", (string)null);
                });
            ...
            modelBuilder.Entity("CarsWebsite.PartnerValueMapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PartnerId", "Field", "ExternalValue")
                        .IsUnique();

                    b.ToTable("partnervaluemappings", (string)null);
                });
            ...
            modelBuilder.Entity("CarsWebsite.CompanyMembership", b =>
                {
                    b.HasOne("CarsWebsite.User", "Member")
                        .WithMany()
                        .HasForeignKey("MemberId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("CarsWebsite.User", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("cars_website_api.CarsWebsite.Domain.Entities.CarAdvert", b =>
                {
                    ...
                    b.HasOne("cars_website_api.CarsWebsite.Domain.Entities.CarAdvert", "DuplicateOf")
                        .WithMany()
